...
AtrName -> 'музей' | 'зал' | 'собор' | 'филармония' | 'авангард' | 'библиотека' | 'площадь' | 'памятник' | 'церковь' | 'часовня' | 'эшелон' | 'мельница' | 'гора' | 'элеватор' | 'фонтан' | 'курган' | 'опера' | 'планетарий' | 'галерея' | 'погост';
